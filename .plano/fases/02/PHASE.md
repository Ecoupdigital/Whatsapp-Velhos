...
**Requisitos cobertos:** API-01, API-02, API-03, API-04, API-05, API-06, API-07, API-08, API-09, TEST-02, TEST-03
...
**Dependencias:** Fase 1
**Estimativa:** 2-3 planos
**Arquivos:** `backend/routers/eventos.py`, `backend/schemas.py`
